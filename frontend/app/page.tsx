      ...
      <section className="h-full flex justify-center items-center">
        <div className="w-[35%] shadow-2xl rounded-xl flex flex-col items-center">
          <section className="flex w-full">
            ...
            <div className="w-1/2 border-b-2 border-gray-300 text-center p-4">
              <p>Cadastro</p>
            </div>
          </section>
          <h1 className="text-4xl font-semibold mt-12 mb-3">Bem-vindo</h1>
          <p className="font-extralight ">Acesse sua conta para continuar</p>
