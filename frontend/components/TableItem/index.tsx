...
export default function TableItem(){
    ...
    return(
        <div className="w-full rounded-2xl overflow-hidden border-2 border-borda my-3 m-auto">
            <Table className="w-full">
                    <TableHeader>
                        <TableRow>
                            <TableHead className="px-10 py-5 bg-card text-textoSecundario">EQUIPAMENTO</TableHead>
                            <TableHead className="px-10 py-5 bg-card text-textoSecundario">STATUS</TableHead>
                            <TableHead className="px-10 py-5 bg-card text-textoSecundario w-[20%]">AÇÕES</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {isError &&
                    ...
                    <TableFooter>
                        <TableRow>
                            <TableCell colSpan={3} className="px-10 py-5  bg-fundoSecundairo text-textoPrincipal">
